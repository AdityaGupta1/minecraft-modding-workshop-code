...
public class EpicChunkGenerator extends NoiseChunkGenerator<EpicGenSettings> {
    ...
    public EpicChunkGenerator(IWorld world, BiomeProvider provider, EpicGenSettings settings) {
